    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> Login(string email, string password, bool rememberMe)
        {
            try
            {
                ...
                return Json(new { redirectUrl = Url.Action("Dashboard", "Admin") });
            }
            catch (Exception ex)
            {
        ...
        public IActionResult Dashboard()
        {
            ...
            ViewData["CanManageStaff"] = userRole == "Admin" || userRole == "SuperAdmin";
            ViewData["CanManageSystem"] = userRole == "Admin" || userRole == "SuperAdmin";
            ViewData["CanViewReports"] = userRole != "Support"; // Support can't view reports
            ViewData["CanManageOrders"] = userRole != "Support"; // Support can only view orders
            ViewData["IsFullAccess"] = userRole == "SuperAdmin"; // SuperAdmin has full access
